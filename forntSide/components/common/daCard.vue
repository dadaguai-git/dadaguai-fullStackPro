<template>
  <d-card class="card-demo-basic mb-5">
    <template #avatar>
    ...
    <template #content>
      DEVUI is a free open-source and common solution for the front end of
      enterprise mid- and back-end products. Its design values are basedon...
    </template>
    <template #actions>
...
<script setup lang="ts">
  ...
  // const props = withDefaults(defineProps<ArticleInfo>(), {});
  // console.log(props);
</script>
